...
const collectionDefinitions = {
  m2: { title: "M2 계획·현황", lead: "M2 실행 계획과 진행 중인 트랙별 산출물입니다.", homeLead: "M2 실행 계획과 진행 중인 트랙별 산출물입니다.", paths: ["deliverables/M2_실행계획_20260817.md", "deliverables/M2_산타바바라_데모미팅_전략_20260818.md", "deliverables/M2_Petify_알파MVP_개발원페이저_20260821.md", "analysis/데모_UI전수와_기획의도_20260820.md"], homePaths: ["deliverables/M2_실행계획_20260817.md", "deliverables/M2_산타바바라_데모미팅_전략_20260818.md", "deliverables/M2_Petify_알파MVP_개발원페이저_20260821.md"] },
  ...
  interview: { title: "고객 인터뷰", lead: "데모 콜 진행 가이드와 사전조사, 콜별 인사이트를 모은 보드입니다.", paths: ["지나인터뷰_계획.md", "deliverables/중간점검_2_Gina_인터뷰_인사이트_202608.md", "deliverables/Track2_리드인터뷰_가이드_20260817.md", "deliverables/M2_데모콜_인사이트보드.md"] },
...
const documentRoles = new Map([
  ...
  ["analysis/Chameleon_실사용동작_조사_20260820.md", "운영 실태"],
...
function renderDocument(id) {
  ...
  if (doc.path === "analysis/포지셔닝_경쟁제품_축비교_20260820.md") bodyClasses.push("visual-doc");
