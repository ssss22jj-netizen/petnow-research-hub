...
const collectionDefinitions = {
  ...
  interview: {
    ...
    lead: "데모 콜별로 확인한 업무 문제와 제품 도입 조건을 비교합니다. 콜별 인터뷰 자료는 인터뷰 모음집에서 볼 수 있습니다. 사전조사와 녹취록은 출처·분석 방법에, 콜 진행 가이드와 체크리스트는 별첨에 있습니다.",
    paths: [
...
const collectionExtras = {
  ...
  reports: [
    ...
    { kind: "page", newTab: true, title: "Second Chance for Love Animal Rescue — Kerrie King", description: "2026-09-10 데모 콜 정리본", role: "정리본 PDF", milestone: "M2", date: "2026-09-10", url: "assets/interview-reports/20260910_Second_Chance_for_Love_Animal_Rescue_Kerrie_King.pdf" },
    { kind: "page", newTab: true, title: "Little Traverse Bay Humane Society — 2차 데모 (Sarah Schertel)", description: "2026-09-10 후속 데모 정리본 — 워크플로우 검증·연동 조건", role: "정리본 PDF", milestone: "M2", date: "2026-09-10", url: "assets/interview-reports/20260910_Little_Traverse_Bay_Humane_Society_2차_Sarah_Schertel.pdf" },
    { kind: "page", newTab: true, title: "Little Traverse Bay Humane Society — 2차 데모 원본 회의록", description: "2026-09-10 Gemini 자동 회의록·전사 (영문)", role: "원본 회의록", milestone: "M2", date: "2026-09-10", url: "assets/interview-reports/20260910_Little_Traverse_Bay_Humane_Society_2차_원본회의록.pdf" },
    { kind: "page", newTab: true, title: "SPACAR Animal Advocates of Oklahoma — Rachel Tatro · Rachel Dockum", description: "2026-09-10 데모 콜 정리본", role: "정리본 PDF", milestone: "M2", date: "2026-09-10", url: "assets/interview-reports/20260910_SPACAR_Animal_Advocates_of_Oklahoma_Rachel_Tatro_Rachel_Dockum.pdf" },
    { kind: "page", newTab: true, title: "Neonatal Kitten Alliance — Andee", description: "2026-09-09 데모 콜 정리본", role: "정리본 PDF", milestone: "M2", date: "2026-09-09", url: "assets/interview-reports/20260909_Neonatal_Kitten_Alliance_Andee.pdf" },
    { kind: "page", newTab: true, title: "Cape Ann Animal Aid — Christina Lewis · Rachel Mason", description: "2026-09-08 데모 콜 정리본", role: "정리본 PDF", milestone: "M2", date: "2026-09-08", url: "assets/interview-reports/20260908_Cape_Ann_Animal_Aid_Christina_Lewis_Rachel_Mason.pdf" },
    { kind: "page", newTab: true, title: "Final Victory — Katy Cowan", description: "2026-09-08 데모 콜 정리본", role: "정리본 PDF", milestone: "M2", date: "2026-09-08", url: "assets/interview-reports/20260908_Final_Victory_Katy_Cowan.pdf" },
    { kind: "page", newTab: true, title: "SPCA International — Haley Weathers · Owen Laukkanen", description: "2026-09-04 크로스보더 제품 데모 정리본 (Gina 소개)", role: "정리본 PDF", milestone: "M2", date: "2026-09-04", url: "assets/interview-reports/20260904_SPCA_International_Haley_Weathers_Owen_Laukkanen.pdf" },
    { kind: "page", newTab: true, title: "Paws and Whiskers — Tawny Arnold", description: "2026-09-03 데모 콜 정리본", role: "정리본 PDF", milestone: "M2", date: "2026-09-03", url: "assets/interview-reports/20260903_Paws_and_Whiskers_Tawny_Arnold.pdf" },
    { kind: "page", newTab: true, title: "Santa Barbara County Animal Services — 라운드테이블 (실무진 8인)", description: "2026-09-03 2차 세션 정리본 — 실무진 8인 라운드테이블", role: "정리본 PDF", milestone: "M2", date: "2026-09-03", url: "assets/interview-reports/20260903_Santa_Barbara_County_Animal_Services_라운드테이블.pdf" },
    { kind: "page", newTab: true, title: "Santa Barbara County Animal Services — 라운드테이블 원본 노트", description: "2026-09-03 펫나우 팀 원본 노트", role: "원본 노트", milestone: "M2", date: "2026-09-03", url: "assets/interview-reports/20260903_Santa_Barbara_County_Animal_Services_라운드테이블_원본노트.pdf" },
    { kind: "page", newTab: true, title: "Asheville Humane Society — Mallory Uzel", description: "2026-09-02 데모 콜 정리본", role: "정리본 PDF", milestone: "M2", date: "2026-09-02", url: "assets/interview-reports/20260902_Asheville_Humane_Society_Mallory_Uzel.pdf" },
    { kind: "page", newTab: true, title: "Maybel’s Legacy — Tanya Mitz", description: "2026-09-02 데모 콜 정리본", role: "정리본 PDF", milestone: "M2", date: "2026-09-02", url: "assets/interview-reports/20260902_Maybels_Legacy_Tanya_Mitz.pdf" },
    { kind: "page", newTab: true, title: "LifeLine Animal Project — Daisy Navin", description: "2026-09-02 데모 콜 정리본", role: "정리본 PDF", milestone: "M2", date: "2026-09-02", url: "assets/interview-reports/20260902_LifeLine_Animal_Project_Daisy_Navin.pdf" },
    { kind: "page", newTab: true, title: "Cactus Ranch Rescue — Tylie Biggs", description: "2026-09-01 데모 콜 정리본", role: "정리본 PDF", milestone: "M2", date: "2026-09-01", url: "assets/interview-reports/20260901_Cactus_Ranch_Rescue_Tylie_Biggs.pdf" },
    { kind: "page", newTab: true, title: "PawSafe Animal Rescue — Sharon Schreiber", description: "2026-09-01 데모 콜 정리본", role: "정리본 PDF", milestone: "M2", date: "2026-09-01", url: "assets/interview-reports/20260901_PawSafe_Animal_Rescue_Sharon_Schreiber.pdf" },
    { kind: "page", newTab: true, title: "Beatrice Humane Society — Carlee Fiddes", description: "2026-08-28 데모 콜 정리본", role: "정리본 PDF", milestone: "M2", date: "2026-08-28", url: "assets/interview-reports/20260828_Beatrice_Humane_Society_Carlee_Fiddes.pdf" },
    { kind: "page", newTab: true, title: "PAWS & More — Amber Talbot", description: "2026-08-25 데모 콜 정리본", role: "정리본 PDF", milestone: "M2", date: "2026-08-25", url: "assets/interview-reports/20260825_PAWS_and_More_Amber_Talbot.pdf" },
    { kind: "page", newTab: true, title: "Humane Society for Greater Savannah — Erica Epperson", description: "2026-08-25 데모 콜 정리본", role: "정리본 PDF", milestone: "M2", date: "2026-08-25", url: "assets/interview-reports/20260825_Humane_Society_for_Greater_Savannah_Erica_Epperson.pdf" },
