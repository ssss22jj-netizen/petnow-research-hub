...
const collectionDefinitions = {
  ...
  interview: { title: "고객 인터뷰", lead: "데모 콜 진행 가이드와 사전조사, 인터뷰별 인사이트와 녹취록입니다.", paths: ["지나인터뷰_계획.md", "deliverables/중간점검_2_Gina_인터뷰_인사이트_202608.md", "deliverables/Track2_리드인터뷰_가이드_20260817.md", "analysis/SantaBarbara_카운티_사전조사_20260817.md", "deliverables/Eve_인터뷰_인사이트_20260817.md", "analysis/Eve인터뷰_녹취록_20260817.md"] },
...
const documentRoles = new Map([
  ...
  ["analysis/Eve인터뷰_녹취록_20260817.md", "녹취록"],
